...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 14 mars 2023 à 12:20
...
INSERT INTO `recette` (`id`, `name`, `pays`, `ingredients`, `etape`, `prix`, `categorie`, `couvert`, `img`) VALUES
...
(6, 'salade caprese', 'Italie', '3 tomates, 2 mozzarella, basilic, origan, huile d\'olive', 'Couper les mozzarella et les tomates en tranches puis les disposer, en alternant, dans une assiette. Y ajouter un filet d\'huile d\'olive, du sel, du poivre, un peu de basilic et d\'origan. Servir frais.', 8, 'entree', 2, '6.jpg'),
(7, 'jambon beurre', 'France', '2 tranches pain de mie, 1 tranche de jambon, beurre', 'Etaler le beurre, puis y disposer la tranche de jambon et recouvrir avec la tranche de pain de mie.', 4, 'aperitif', 1, '7.jpg'),
(8, 'sauce fond de veau', 'France', 'fond de veau, eau, herbes aromatiques', 'Faire rÃ©duire dans un volume d\'eau votre fond de veau avec des herbes aromatiques, ainsi que poivrez lÃ©gÃ¨rement.', 3, 'sauce', 2, '8.jpg'),
(10, 'mousse au chocolat', 'France', '500 g de chocolat noir (80%), 10 oeufs, sucre, sel', 'Faites fondre le chocolat noir dans un bain marie et pendant ce temps sÃ©parer le blanc des jaunes puis monter en neige Ã  l\'aide d\'une pincÃ©e de sel les blancs. DÃ¨s que le chocolat en fondue, laissez-le refroidir puis y mÃ©langer les jaunes. Enfin, Ajouter le sucre dans le chocolat puis incorporez dÃ©licatement l\'appareil aux blancs.\r\nPour finir, mettez le au frigo une bonne nuit pour que la mousse prenne une belle consistance.', 12, 'dessert', 5, '10.png'),
(16, 'Lasagnes', 'Italie', 'Pate lasagnes, sauce tomate, steak hachÃ©', 'Plongez vos lasagnes dans de la sauce bÃ©chamel, puis y ajouter le steak hachÃ© et les recouvrir avec de la sauce tomate...', 12, 'plat', 3, '16.jpeg');
